package de.krasosu.spring.data.es.config;
...
public class SpringFoxConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("REST API", "Spring Data Elasticsearch.", "0.0.1", "Terms of service",
                new Contact("Krasosu", "krasosu.de", "info@krasosu.de"), "License of API", "API license URL",
